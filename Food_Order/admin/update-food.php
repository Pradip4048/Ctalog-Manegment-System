...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM the_food WHERE id=$id";
        //execute the Query
    ...
    else
    {
        ...
        header('location:'.SITEURL.'admin/menage-food.php');
    }
?>
        ...
        <table class="tbl-30">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Food" class="btn-secoundry">
                </td>
            </tr>
